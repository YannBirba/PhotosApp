...
export const eventGetAllError = createAction(
  '[Event] {API} Get all (error)'
);
...
export const eventGetError = createAction(
  '[Event] {API} all (error)'
);
...
export const eventCreateError = createAction(
  '[Event] {API} Create (error)'
);
...
export const eventUpdateError = createAction(
  '[Event] {API} Update (error)'
);
...
export const eventDeleteError = createAction(
  '[Event] {API} Delete (error)'
);
